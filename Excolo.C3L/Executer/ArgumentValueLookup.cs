...
namespace Excolo.C3L.Executer
{
    ...
    /// </summary>
    public class ArgumentValueLookup : ArgumentValueLookup<IArgument>
    {
        /// <summary>
    ...
    public class ArgumentValueLookup<TArgumentType> : IEnumerable<KeyValuePair<string, TArgumentType>>
    {
        ...
        /// </summary>
        /// <param name="values">The collection of key-value pairs to create the lookup from.</param>
        public ArgumentValueLookup(IEnumerable<KeyValuePair<string, TArgumentType>> values)
        {
            _table = values;
        ...
        /// </summary>
        /// <param name="dictionary">The dictionary to create the lookup from.</param>
        public ArgumentValueLookup(IDictionary<string, TArgumentType> dictionary)
        { 
            if(dictionary != null)
            {
        ...
        /// of the dictionary typeparameter, the values is discarded.
        /// </param>
        public ArgumentValueLookup(object values)
        {
